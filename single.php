 ...
 * (Versione 4: Meta Autore dentro una Card)
 */
            ...
            <?php while ( have_posts() ) : the_post(); ?>
                ...
                <article id="post-<?php the_ID(); ?>" <?php post_class('single-post-container'); ?>>
                    ...
                    <div class="single-post-hero">
                        ...
                        <?php else : // Placeholder per immagine mancante ?>
                    ...
                    <?php // 2. BLOCCO META (Autore e Categoria/Tags) - INSERITO IN UNA CARD ?>

                    <section class="author-box-article"> <?php // <-- NUOVO CONTENITORE CARD ?>
                        ...
                        <div class="single-post-meta">
                            ...
                            <div class="meta-top-row">
                                <div class="meta-author">
                                    ...
                                    <div class="author-info">
                                        <a class="author-name-link" href="<?php echo esc_url( get_author_posts_url( get_the_author_meta( 'ID' ) ) ); ?>">
                                        ...
                                        <div class="author-socials">
                                            ...
                                            // --- CHIAVI CORRETTE (come da functions.php) ---
                            ...
                            if ( ! empty( $categories ) || ! empty( $tags ) ) {
                                ...
                                echo '<div class="meta-tags">'; // La classe ora centra gli elementi

                                // 1. Mostra la "bolla" della Categoria
                                if ( ! empty( $categories ) ) {
                                ...
                                if ( $tags ) {
                                    $count = 0;
                                    foreach( $tags as $tag ) {
                                        if ( $count >= 2 ) break; // Limite a 2 tags
                    ...
                    </section> <?php // <-- CHIUSURA NUOVO CONTENITORE CARD ?>
