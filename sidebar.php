...
<aside class="sidebar">
    ...
    <button class="sidebar-toggle" aria-expanded="false" aria-controls="sidebar-content">
        ...
        <span class="sidebar-toggle-label">
            <svg class="sidebar-toggle-icon-main" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 1a3 3 0 0 0-3 3v8a3 3 0 0 0 6 0V4a3 3 0 0 0-3-3z"></path><path d="M19 10v2a7 7 0 0 1-14 0v-2"></path><line x1="12" y1="19" x2="12" y2="23"></line><line x1="8" y1="23" x2="16" y2="23"></line></svg>

            <h3 class="sidebar-toggle-title">Radio UVM</h3>
        </span>

        <svg class="sidebar-toggle-icon" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="6 9 12 15 18 9"></polyline></svg>
    </button>
    ...
    <div class="sidebar-content" id="sidebar-content">
        ...
        <div class="spotify-player-card">
            ...
            <div class="spotify-player__header">
                <img src="https://placehold.co/100x100/EFEFEF/1a1a1a?text=..." alt="Cover episodio" id="episode-cover" class="spotify-player__image">
                <div class="spotify-player__info">
                    ...
                    <a href="#" id="spotify-link" target="_blank" rel="noopener noreferrer" class="spotify-player__button">
