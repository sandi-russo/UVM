                                    ...
                                    <div class="role-selection">
                                        ...
                                        <div class="checkbox-group">
                                            <label><input type="checkbox" name="ruolo[]"
                                                    value="Giornale">Giornale</label>
                                            <label><input type="checkbox" name="ruolo[]" value="Radio">Radio</label>
                                            <label><input type="checkbox" name="ruolo[]"
                                                    value="Creativa / Grafica">Creativa / Grafica</label>
                                            <label><input type="checkbox" name="ruolo[]" value="Social">Social</label>
                                            <label><input type="checkbox" name="ruolo[]"
